...
const pagesRouterDetection = require('./pagesRouterDetection.js');

function setUpBuildTimeVariables(userNextConfig, userSentryOptions, releaseName, projectDir = process.cwd()) {
  ...
  if (pagesRouterDetection.hasOnlyAppRouterPages(projectDir)) {
