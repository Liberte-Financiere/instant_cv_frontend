    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-slate-200/60 h-16 sticky top-0 z-40 px-3 sm:px-6 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            className="lg:hidden flex items-center gap-2 px-3 py-2.5 text-indigo-600 bg-indigo-50 hover:bg-indigo-100 rounded-xl text-sm font-bold transition-all"
          >
      ...
      <AnimatePresence>
        {showMobilePreview && (
          ...
          >
            <div className="flex items-center justify-between p-4 bg-white/90 backdrop-blur-md border-b border-slate-200">
              <h3 className="font-bold text-slate-900">Aperçu de la lettre</h3>
              <button 
            ...
            <div className="flex-1 overflow-auto p-4 flex justify-center">
              <div className="origin-top" style={{ transform: 'scale(0.45)', transformOrigin: 'top center' }}>
                <LetterPreview 
                  coverLetter={currentCL} 
