    ...
    <div className="max-w-3xl mx-auto space-y-8 p-8">
      ...
      <div>
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900">Publier une Offre d'Emploi</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white border border-slate-200 shadow-sm rounded-2xl p-6 md:p-8 space-y-8">
        ...
        <div className={step === 1 ? 'space-y-6 block' : 'hidden'}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-semibold text-slate-700">Candidature via *</label>
              <select 
        ...
        <div className="flex items-center justify-between pt-6 border-t border-slate-200">
          {step > 1 ? (
            ...
            <div /> /* Placeholder for flex justify-between to keep "Suivant" on the right */
          )}
          ...
          {step < 3 ? (
            ...
            >
              {loading ? 'Publication...' : (
                <>
                  <Save className="w-5 h-5 mr-2" /> Publier l'offre
                </>
              )}
            </Button>
          )}
