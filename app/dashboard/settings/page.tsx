...
import {User, Check, ChevronDown, Eye, Shield, FileText, ChevronLeft, ChevronRight, GraduationCap, Coins, Wand2} from 'lucide-react';
...
const TABS = [
  ...
  { id: 'credits', label: 'Crédits & Parrainage', icon: Coins },
          ...
          return (
            <button
              ...
              className={`relative flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium whitespace-nowrap transition-colors ${
                isActive ? 'text-indigo-600' : 'text-slate-600 hover:bg-slate-200/50'
              }`}
            >
              {isActive && (
                <motion.div
