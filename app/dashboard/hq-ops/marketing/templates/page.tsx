    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
           ...
           <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow group flex flex-col">
             <div className="h-48 bg-slate-900 relative p-4 flex items-center justify-center overflow-hidden">
               ...
               {/* Abstract Promo layout */}
                ...
                <div className="w-3/4 h-3/4 bg-white shadow-xl rounded-lg overflow-hidden border-2 border-blue-500/30 flex flex-col relative z-0 group-hover:scale-105 transition-transform duration-500">
                  <div className="h-10 bg-blue-600 w-full flex items-center justify-center">
                  ...
                  <div className="p-3 text-center flex flex-col items-center">
                    ...
                    <div className="w-20 h-5 bg-blue-600 rounded-full mt-1"></div>
                  </div>
                </div>
             </div>
             <div className="p-6 flex flex-col flex-1">
           ...
           {/* Card 4: Nouveauté Live (Light Style) */}
           <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow group flex flex-col">
             <div className="h-48 bg-blue-50 relative p-4 flex items-center justify-center overflow-hidden">
               <div className="absolute top-4 right-4 bg-white text-blue-600 border border-blue-100 text-xs font-black uppercase tracking-wider px-3 py-1 rounded shadow-sm z-10">
                 Nouveauté
               </div>
               {/* Abstract Nouveaute layout (Landing Page Style) */}
               <div className="w-3/4 h-3/4 bg-white shadow-xl rounded-lg overflow-hidden border border-slate-200 flex flex-col relative z-0 group-hover:scale-105 transition-transform duration-500">
                 <div className="p-3 h-full bg-slate-50">
                   {/* Top: Avatar & Badge */}
                   <div className="flex justify-between items-start mb-2">
                     <div className="w-6 h-6 bg-gradient-to-br from-violet-600 to-indigo-600 rounded"></div>
                     <div className="w-10 h-3 bg-green-100 rounded-full border border-green-200"></div>
                   </div>
                   {/* Lines */}
                   ...
                   <div className="flex gap-1 mt-auto">
                     <div className="flex-1 h-3 border border-slate-200 rounded-sm"></div>
                     <div className="flex-1 h-3 border border-slate-200 rounded-sm"></div>
                     <div className="flex-1 h-3 border border-slate-200 rounded-sm"></div>
                   </div>
                 </div>
             ...
             <div className="p-6 flex flex-col flex-1">
               <h3 className="text-lg font-black text-slate-900 mb-2">Nouveauté Live</h3>
               <p className="text-sm text-slate-500 mb-6 flex-1">Design moderne et lumineux avec illustration de tableau de bord. Parfait pour annoncer la sortie de nouvelles fonctionnalités.</p>
               
               <div className="flex items-center justify-end pt-4 border-t border-slate-100">
                 <div className="flex gap-2 w-full">
                   <button 
                     onClick={() => setPreviewTemplate('nouveaute')}
                     className="flex-1 py-2 text-sm font-bold text-blue-600 hover:bg-blue-50 rounded-xl transition-colors flex items-center justify-center gap-2"
                   >
                     <Eye className="w-4 h-4" /> Aperçu
                   </button>
                   <Link href="/dashboard/hq-ops/marketing?template=nouveaute" className="flex-1 py-2 text-sm font-bold text-slate-700 border border-slate-200 bg-white hover:bg-slate-50 rounded-xl transition-colors shadow-sm flex items-center justify-center text-center">
                     Utiliser
                   </Link>
                 </div>
               </div>
