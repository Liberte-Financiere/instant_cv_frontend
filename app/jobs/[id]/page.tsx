...
import { AIMatchWidget } from '@/components/jobs/AIMatchWidget';
            ...
            <section className="space-y-4">
              ...
              <ul className="flex flex-wrap gap-2 mt-4">
                {job.requirements.map((req: string, idx: number) => (
                  <li key={idx} className="inline-flex items-center text-sm font-semibold text-slate-700 bg-white px-4 py-2 rounded-xl border border-slate-200 shadow-sm hover:border-primary/50 hover:shadow-md transition-all cursor-default">
                    {req}
                  </li>
                ))}
              </ul>
